...
Understanding n8n’s data structure and item handling

Configuring nodes and managing credentials

Using Schedule Triggers for automation

Making API calls using HTTP Request nodes

Applying conditional logic with IF nodes

Processing and aggregating data using JavaScript Code nodes
